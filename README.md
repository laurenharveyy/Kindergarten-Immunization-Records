...
Therefore, my story will focus on exemption trends in California counties over time. Specifically, it will compare pre-2016 exemptions with data from the 2018-2019 school year in order to see how legislation has changed vaccination patterns. Additionally, by consulting with experts on the issue, I will determine key drivers of these trends, particularly in counties that have sustained high exemption rates after Senate Bill 277, such as Nevada County.
